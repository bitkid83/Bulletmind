...
entity_t* ent_spawn(entity_t* ent_list, const char* name, const vec2f_t org, const vec2i_t size, const rgba_t* color, const int32_t caps, const double lifetime);
...
void ent_set_vel(entity_t* e, const vec2f_t vel, float ang);
...
void ent_move_player(entity_t* player, engine_t* engine, const double dt);

void ent_move_satellite(entity_t* satellite, entity_t* player, engine_t* engine, const double dt);

void ent_move_bullet(entity_t* bullet, engine_t* engine, const double dt);
